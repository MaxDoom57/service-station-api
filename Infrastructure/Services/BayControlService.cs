...
namespace Infrastructure.Services
{
    public class BayControlService
    {
        ...
        public async Task<(bool success, string message, int resKy)> CreateReservationAsync(CreateReservationDto dto)
        {
            ...
            // Check overlaps for APPROVED reservations only? 
            // Usually we shouldn't allow even overlapping Pending requests to avoid double booking logic complexity, 
            // OR we allow Pending and Admin rejects duplicates. 
            // Let's block Approve Overlaps.
        ...
        public async Task<List<ReservationDto>> GetReservationsAsync(string? status, DateTime? date)
        {
            ...
            // Note: Join is better for BayNm, skipping for brevity/performance unless requested.
        }
